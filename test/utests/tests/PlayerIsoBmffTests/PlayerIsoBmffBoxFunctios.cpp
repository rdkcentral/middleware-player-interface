 ...
 */
TEST(PlayerIsoBmffBoxTests, ValidConstructionWithTypicalParameters) {
 ...
 */
TEST(PlayerIsoBmffBoxTests, ConstructWithSize100AndFtyp) {
    std::cout << "Entering ConstructWithSize100AndFtyp test" << std::endl;
    
    uint32_t sz = 100;
    char btype[4];
    uint8_t ver = 1;
	uint32_t flags = 0XFFFFFF;
    ...
    EXPECT_NO_THROW({
        player_isobmff::FullIsoBmffBox box(sz, btype,ver,flags);
 ...
 */
TEST(PlayerIsoBmffBoxTests, ConstructWithMaxSizeAndMdat) {
    ...
    // Invoke the constructor and check no exception is thrown
    EXPECT_NO_THROW({
        player_isobmff::FullIsoBmffBox box(sz, btype,version,flags);
        std::cout << "player_isobmff::FullIsoBmffBox object created with sz = " 
                  << sz << " and btype = " << std::string(btype, sizeof(btype)) << std::endl;
    });
 ...
 */
TEST(PlayerIsoBmffBoxTests, ValidBoxCreation_ftyp) {
 ...
 */
TEST(PlayerIsoBmffBoxTests, ValidBoxCreation_moov) {
 ...
 */
TEST(PlayerIsoBmffBoxTests, addValidChildBoxToEmptyContainer) {
 ...
 */
TEST(PlayerIsoBmffBoxTests, addNullChildBoxPointer) {
 ...
 */
TEST(PlayerIsoBmffBoxTests, ValidContainerConstructionWithDefaultNewTrackId) {
 ...
 */
TEST(PlayerIsoBmffBoxTests, RetrieveChildrenEmpty) {
 ...
 */
TEST(PlayerIsoBmffBoxTests, hasChildren_NoChildrenReturnsFalse) {
 ...
 */
TEST(PlayerIsoBmffBoxTests, DestructorNoChildren) {
 ...
 */
TEST(PlayerIsoBmffBoxTests, VirtualDestructorViaBasePointer) {
 ...
 */
TEST(player_isobmff_IsoBmffBox, truncate_start) {
...
TEST(player_isobmff_PrftIsoBmffBox, CreateInstanceWithSzZero) {
    ...
    EXPECT_NO_THROW({
        ...
        EXPECT_EQ(sz, 0u);
        EXPECT_EQ(box.getTrackId(), trackId);
        EXPECT_EQ(box.getNtpTs(), ntpTs);
        EXPECT_EQ(box.getMediaTime(), mediaTime);
    });
...
TEST(player_isobmff_PrftIsoBmffBox, setTrackId_typical) {
    ...
    EXPECT_NO_THROW({
        ...
        EXPECT_EQ(retTrackId, newTrackId);
    });
 ...
 */
TEST(PlayerIsoBmffBoxTests, ValidSidxConstruction) {
 ...
 */
TEST(PlayerIsoBmffBoxTests, ConstructionWithZeroTimeScale) {
 ...
 */
TEST(PlayerIsoBmffBoxTests, ConstructionWithZeroSidxDuration) {
 ...
 */
TEST(PlayerIsoBmffBoxTests, ValidConstructionTypicalValues) {
 ...
 */
TEST(PlayerIsoBmffBoxTests, ConstructSidxBox_with_valid_SIDX_box_data) {
 ...
 */
TEST(PlayerIsoBmffBoxTests, getSampleDuration_secondConstructor_positiveDuration) {
 ...
 */
TEST(PlayerIsoBmffBoxTests, getSampleDuration_firstConstructor_positiveDuration) {
 ...
 */
TEST(PlayerIsoBmffBoxTests, getTimeScale_returns_correct_value_for_constructor1) {
 ...
 */
TEST(PlayerIsoBmffBoxTests, getTimeScale_returns_correct_value_for_constructor2) {
 ...
 */
TEST(PlayerIsoBmffBoxTests, setTimeScale_typical_positive_value) {
