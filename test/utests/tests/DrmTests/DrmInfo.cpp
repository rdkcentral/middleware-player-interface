...
class DrmInfoTests : public ::testing::Test
{
protected:
	void SetUp() override
	{
 ...
 */
TEST_F(DrmInfoTests, DefaultConstructorInitializesAllMembersToTheirExpectedDefaultValues) {
 ...
 */
TEST_F(DrmInfoTests, CopyDefaultDrmInfo) {
 ...
 */
TEST_F(DrmInfoTests, CopyDrmInfoWithCustomizedValues) {
 ...
 */
TEST_F(DrmInfoTests, Negative_ModifyingOriginalAfterCopy) {
 ...
 */
TEST_F(DrmInfoTests, PositiveAssignment) {
 ...
 */
TEST_F(DrmInfoTests, LoopThroughDrmMethodEnum) {
 ...
 */
TEST_F(DrmInfoTests, NegativeDeepCopyIV) {
 ...
 */
TEST_F(DrmInfoTests, DestructorAutomatically) {
