...
TEST(ContentSecurityManager, DestroyInstance_start) {
    ...
    TestContentSecurityManager *instance = nullptr;
    EXPECT_NO_THROW({
        instance = new TestContentSecurityManager();
...
TEST(ContentSecurityManager, ValidInput_PositiveValues) {
    ...
    EXPECT_NO_THROW({
        TestContentSecurityManager contentSecManager;
        std::cout << "Created ContentSecurityManager object using default constructor." << std::endl;
...
TEST_F(ContentSecurityManagerTest, ContentSecurityManager_ContentSecurityManager_start) {
    ...
    EXPECT_NO_THROW({
        ...
        TestContentSecurityManager tempManager;  // Calls the default constructor internally
        std::cout << "Temporary ContentSecurityManager object created successfully." << std::endl;
    });
 ...
 */
TEST(FakeSecManager, NegativeSessionId_SetPlaybackSpeedState)
{
    std::cout << "Entering NegativeSessionId test" << std::endl;
 ...
 */
TEST(FakeSecManager, NegativeSessionId_setVideoWindowSize) {
    std::cout << "Entering NegativeSessionId test" << std::endl;
 ...
 */
TEST(FakeSecManager, NegativeSessionId_NegativeSessionId) {
    std::cout << "Entering NegativeSessionId test" << std::endl;
    EXPECT_NO_THROW({
        FakeSecManager fakeSecManager;
        std::cout << "Constructed FakeSecManager object successfully" << std::endl;
