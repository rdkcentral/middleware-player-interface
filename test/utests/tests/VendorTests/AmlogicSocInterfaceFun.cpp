...
/// ---- Mocking g_object_set ----
extern "C" {
    void __wrap_g_object_set(gpointer object, const gchar *first_property_name, ...);
}

static int g_lastTrackId = -1;
static std::string g_lastProperty;
static gpointer g_lastSrc = nullptr;

/**
 * @brief Mock implementation of g_object_set to capture calls
 */
void __wrap_g_object_set(gpointer object, const gchar *first_property_name, ...) {
    g_lastSrc = object;
    g_lastProperty = first_property_name;

    va_list args;
    va_start(args, first_property_name);
    g_lastTrackId = va_arg(args, int);
    va_end(args);
}
class AmlogicSocInterfaceTest : public ::testing::Test
{
protected:
    AmlogicSocInterface iface;  ///< Object under test
    GstElement dummyElement;    ///< Dummy GStreamer element
    void SetUp() override {
        g_lastTrackId = -1;
        g_lastProperty.clear();
        g_lastSrc = nullptr;
 ...
 */
TEST_F(AmlogicSocInterfaceTest, AmlogicSocInterface_constructor_start) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, NullAudioSinkWithValidSource) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, ValidAudioSinkWithNullSource) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, NullDecHandle) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, NullVideoDec) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, NullSinkbinTest) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, ValidAudioDecoderNameRialtoTrue) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, ValidVideoDecoderNameRialtoTrue_IsAudioOrViddeo) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, ValidAudioDecoderNameRialtoFalse) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, ValidVideoDecoderNameRialtoFalse) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, NullNameRialtoTrue) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, NullNameRialtoFalse) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, EmptyNameRialtoTrue) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, EmptyNameRialtoFalse) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, ValidAudioSinkFalse) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, ValidAudioSinkTrue) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, ValidAudioDecoderFalse) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, ValidAudioDecoderTrue) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, InvalidVideoSinkFalse) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, InvalidVideoSinkTrue) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, NullNameFalse) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, NullNameTrue) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, EmptyStringFalse) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, EmptyStringTrue) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, ValidVideoDecoderNameRialtoTrue) {
    std::cout << "Entering ValidVideoDecoderNameRialtoTrue test" << std::endl;
 ...
 */
TEST_F(AmlogicSocInterfaceTest, ValidVideoDecoderNameRialtoFalse_IsVideoDecoder) {
    std::cout << "Entering ValidVideoDecoderNameRialtoFalse test" << std::endl;
 ...
 */
TEST_F(AmlogicSocInterfaceTest, NullNameParameter) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, EmptyNameParameter) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, NonVideoDecoderNameAudio) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, NonVideoDecoderNameRandom) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, IsVideoSink_ValidVideoSink_RialtoFalse)
{
 ...
 */
TEST_F(AmlogicSocInterfaceTest, IsVideoSink_ValidVideoSink_RialtoTrue)
{
 ...
 */
TEST_F(AmlogicSocInterfaceTest, IsVideoSink_NonVideoSink_RialtoFalse)
{
 ...
 */
TEST_F(AmlogicSocInterfaceTest, IsVideoSink_NonVideoSink_RialtoTrue)
{
 ...
 */
TEST_F(AmlogicSocInterfaceTest, IsVideoSink_InvalidName_RialtoFalse)
{
 ...
 */
TEST_F(AmlogicSocInterfaceTest, IsVideoSink_NullName_RialtoFalse)
{
 ...
 */
TEST_F(AmlogicSocInterfaceTest, IsVideoSink_EmptyString_RialtoFalse)
{
 ...
 */
TEST_F(AmlogicSocInterfaceTest, ResetNewSegmentEvent_ReturnsTrue) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, ValidInputNonEmptyProperties) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, ValidInputEmptyVolume) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, ValidInputEmptyMute) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, NegativeInputNullVolume) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, NegativeInputNullMute) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, PositiveTestZeroFlagsNonSub) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, PositiveTestNonZeroFlagsNonSub) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, PositiveTestZeroFlagsSub) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, NegativeTestNegativeFlagsNonSub) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, BoundaryTestMaxFlagsNonSub) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, BoundaryTestMinFlagsNonSub) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, BoundaryTestMaxFlagsSub) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, BoundaryTestMinFlagsSub) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, NullPipelinePointer)
{
 ...
 */
TEST_F(AmlogicSocInterfaceTest, NullVideoDecoderPointer)
{
 ...
 */
TEST_F(AmlogicSocInterfaceTest, NullAudioDecoderPointer)
{
 ...
 */
TEST_F(AmlogicSocInterfaceTest, ZeroPlaybackRateValue)
{
 ...
 */
TEST_F(AmlogicSocInterfaceTest, EmptySourcesVector)
{
 ...
 */
TEST_F(AmlogicSocInterfaceTest, ValidateSetRateCorrectionDefaultBehavior) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, ValidGstElement_EnableSeamlessSwitch) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, ValidGstElement_DisableSeamlessSwitch) {
 ...
 */
TEST_F(AmlogicSocInterfaceTest, NullGstElement_EnableSeamlessSwitch) {
...
TEST_F(AmlogicSocInterfaceTest, SetsPropertyCorrectly) {
    ...
    EXPECT_EQ(g_lastProperty, "ac4-presentation-group-index");
    EXPECT_EQ(g_lastTrackId, 5);
}
...
TEST_F(AmlogicSocInterfaceTest, SetsPropertyWithLargeTrackId) {
    ...
    EXPECT_EQ(g_lastTrackId, largeId);
}
...
/**
 * @test Verify that when src is null, no property is set and no g_object_set call is made.
 */
TEST_F(AmlogicSocInterfaceTest, NullSrcDoesNotSetProperty) {
    iface.SetAC4Tracks(nullptr, 10);

    EXPECT_EQ(g_lastSrc, nullptr);
    EXPECT_TRUE(g_lastProperty.empty());
...
TEST_F(AmlogicSocInterfaceTest, MultipleCallsUpdateTrackId) {
    ...
    iface.SetAC4Tracks(&dummyElement, 2);
    EXPECT_EQ(g_lastTrackId, 2);

    iface.SetAC4Tracks(&dummyElement, 3);
    EXPECT_EQ(g_lastTrackId, 3);
}
