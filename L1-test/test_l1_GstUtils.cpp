 ...
 */
TEST(PlayerCliGstInit_NullArgc, NegativeTestWithNULLForArgc)
{
 ...
 */
TEST(PlayerCliGstInit_NullArgv, NegativeTestWithNULLForArgv)
{
 ...
 */
TEST(PlayerCliGstTermTests, PlayerCliGstTerm_start) {
    char testName[50];
 ...
 */
TEST(gstGetMediaTypeNameTest, ValidGstMediaType)
{
 ...
 */
TEST(gstGetMediaTypeNameTest, InvalidGstMediaType)
{
    ...
    {
        int mediaType = invalidMediaTypes[i];
