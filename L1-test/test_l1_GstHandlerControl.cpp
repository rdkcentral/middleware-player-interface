 ...
 */
TEST(GstHandlerControl_ScopeHelper, ScopeHelper_defaultConstructor_initializes_mpController_to_nullptr) {
 ...
 */
TEST(GstHandlerControl_ScopeHelper, ConstructWithNullController) {
 ...
 */
TEST(GstHandlerControl_ScopeHelper, ConstructWithValidController) {
...
TEST(GstHandlerControl_ScopeHelper, MoveAssignValidSourceToEmptyDestination) {
    ...
    // Create a valid GstHandlerControl instance on the heap for source.
    GstHandlerControl* controller = new GstHandlerControl();
    std::cout << "Created controller with pointer: " << controller << std::endl;
    
    // Create source ScopeHelper with the valid controller pointer.
    GstHandlerControl::ScopeHelper source(controller);
    std::cout << "Source ScopeHelper created with controller pointer (via explicit constructor)." << std::endl;
    
    // Create destination ScopeHelper using default constructor (mpController = nullptr).
    GstHandlerControl::ScopeHelper destination;
    std::cout << "Destination ScopeHelper created with default constructor (controller pointer = nullptr)." << std::endl;
    ...
    // Cleanup: Delete the allocated controller.
    delete controller;
    std::cout << "Deleted controller pointer: " << controller << std::endl;
