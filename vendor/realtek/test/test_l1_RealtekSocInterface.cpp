 ...
 */
TEST(RealtekSocInterface, ConfigureAudioSink_ValidAudioSink_TrueSync) {
 ...
 */
TEST(RealtekSocInterface, ConfigureAudioSink_ValidAudioSink_FalseSync) {
 ...
 */
TEST(RealtekSocInterface, ConfigureAudioSink_NullAudioSink) {
 ...
 */
TEST(RealtekSocInterface, ConfigureAudioSink_NullSrc) {
 ...
 */
TEST(RealtekSocInterface, ValidAudioSinkStandardPlaybackNotSeeking) {
 ...
 */
TEST(RealtekSocInterface, ValidAudioSinkStandardPlaybackWhileSeeking) {
 ...
 */
TEST(RealtekSocInterface, NullAudioSinkPointer) {
 ...
 */
TEST(RealtekSocInterface, ValidAudioSinkNegativePlaybackRate) {
 ...
 */
TEST(RealtekSocInterface, ValidAudioSinkZeroPlaybackRate) {
 ...
 */
TEST(RealtekSocInterface, Verify_EnableLiveLatencyCorrection_returns_true_with_default_state) {
 ...
 */
TEST(RealtekSocInterface, ValidInputPointers) {
 ...
 */
TEST(RealtekSocInterface, NullDecHandlePointer) {
 ...
 */
TEST(RealtekSocInterface, NullVideoDecPointer) {
 ...
 */
TEST(RealtekSocInterface, ValidNonWesteros) {
 ...
 */
TEST(RealtekSocInterface, ValidWesteros) {
 ...
 */
TEST(RealtekSocInterface, NullVideoSink) {
 ...
 */
TEST(RealtekSocInterface, NullVideoDec) {
 ...
 */
TEST(RealtekSocInterface, NullSinkbinInputReturnsNullVideoSink) {
 ...
 */
TEST(RealtekSocInterface, ValidSinkbinWithContainedVideoSinkReturnsNonNullVideoSink) {
 ...
 */
TEST(RealtekSocInterface, HasFirstAudioFrameCallback_returns_false_default_internal_state) {
 ...
 */
TEST(RealtekSocInterface, IsAudioFragmentSyncSupported_returnsTrueOrFalse)
{
 ...
 */
TEST(RealtekSocInterface, ValidAudioDecoderIsRialtoTrue)
{
 ...
 */
TEST(RealtekSocInterface, ValidAudioDecoderIsRialtoFalse)
{
 ...
 */
TEST(RealtekSocInterface, ValidVideoDecoderIsRialtoTrue)
{
 ...
 */
TEST(RealtekSocInterface, ValidVideoDecoderIsRialtoFalse)
{
 ...
 */
TEST(RealtekSocInterface, InvalidDecoderNameIsRialtoTrue)
{
 ...
 */
TEST(RealtekSocInterface, InvalidDecoderNameIsRialtoFalse)
{
 ...
 */
TEST(RealtekSocInterface, NullNameParameterIsRialtoTrue)
{
 ...
 */
TEST(RealtekSocInterface, EmptyStringNameIsRialtoFalse)
{
 ...
 */
TEST(RealtekSocInterface, IsAudioSinkOrAudioDecoder_NameNull_RialtoFalse)
{
 ...
 */
TEST(RealtekSocInterface, IsAudioSinkOrAudioDecoder_NameNull_RialtoTrue)
{
 ...
 */
TEST(RealtekSocInterface, IsAudioSinkOrAudioDecoder_EmptyName_RialtoFalse)
{
 ...
 */
TEST(RealtekSocInterface, IsAudioSinkOrAudioDecoder_EmptyName_RialtoTrue)
{
 ...
 */
TEST(RealtekSocInterface, IsAudioSinkOrAudioDecoder_AudioSink_RialtoFalse)
{
 ...
 */
TEST(RealtekSocInterface, IsAudioSinkOrAudioDecoder_AudioSink_RialtoTrue)
{
 ...
 */
TEST(RealtekSocInterface, IsAudioSinkOrAudioDecoder_AudioDecoder_RialtoFalse)
{
 ...
 */
TEST(RealtekSocInterface, IsAudioSinkOrAudioDecoder_AudioDecoder_RialtoTrue)
{
 ...
 */
TEST(RealtekSocInterface, IsAudioSinkOrAudioDecoder_VideoSink_RialtoFalse)
{
 ...
 */
TEST(RealtekSocInterface, IsAudioSinkOrAudioDecoder_RandomName_RialtoTrue)
{
 ...
 */
TEST(RealtekSocInterface, IsFirstTuneWithWesteros_start) {
 ...
 */
TEST(RealtekSocInterface, IsPlaybackQualityFromSink_start) {
 ...
 */
TEST(RealtekSocInterface, ValidVideoDecoderRialtoTrue) {
 ...
 */
TEST(RealtekSocInterface, ValidVideoDecoderRialtoFalse) {
 ...
 */
TEST(RealtekSocInterface, InvalidVideoDecoderAudioNameRialtoTrue) {
...
TEST(RealtekSocInterface, InvalidVideoDecoderAudioNameRialtoFalse) {
 ...
 */
TEST(RealtekSocInterface, NullNameRialtoTrue) {
 ...
 */
TEST(RealtekSocInterface, NullNameRialtoFalse) {
 ...
 */
TEST(RealtekSocInterface, EmptyNameRialtoTrue) {
 ...
 */
TEST(RealtekSocInterface, EmptyNameRialtoFalse) {
 ...
 */
TEST(RealtekSocInterface, ValidVideoSinkWithRialtoTrue) {
 ...
 */
TEST(RealtekSocInterface, ValidVideoSinkWithRialtoFalse) {
 ...
 */
TEST(RealtekSocInterface, NonVideoSinkWithRialtoTrue) {
 ...
 */
TEST(RealtekSocInterface, NonVideoSinkWithRialtoFalse) {
 ...
 */
TEST(RealtekSocInterface, NullNamePointerInput) {
 ...
 */
TEST(RealtekSocInterface, EmptyStringName) {
 ...
 */
TEST(RealtekSocInterface, IsVideoSinkHandleErrors_start) {
 ...
 */
TEST(RealtekSocInterface, NotifyVideoFirstFrame_start) {
 ...
 */
TEST(RealtekSocInterface, RealtekSocInterface_Instantiation_start) {
 ...
 */
TEST(RealtekSocInterface, RequiredElementSetup_start) {
 ...
 */
TEST(RealtekSocInterface, StandardInvocationReturnsCorrectNumberOfQueuedFrames) {
 ...
 */
TEST(RealtekSocInterface, ResetTrickUTC_ReturnValue) {
 ...
 */
TEST(RealtekSocInterface, ValidGstElementPositiveTrackId) {
 ...
 */
TEST(RealtekSocInterface, ValidGstElementZeroTrackId) {
 ...
 */
TEST(RealtekSocInterface, NullGstElementPointer) {
 ...
 */
TEST(RealtekSocInterface, ValidGstElementNegativeTrackId) {
 ...
 */
TEST(RealtekSocInterface, ValidGstElementExtremelyLargeTrackId) {
 ...
 */
TEST(RealtekSocInterface, PositiveCaseNonEmptyFalse) {
 ...
 */
TEST(RealtekSocInterface, PositiveCaseNonEmptyTrue) {
 ...
 */
TEST(RealtekSocInterface, NegativeCaseNullVolume) {
 ...
 */
TEST(RealtekSocInterface, NegativeCaseNullMute) {
 ...
 */
TEST(RealtekSocInterface, NegativeCaseEmptyVolume) {
 ...
 */
TEST(RealtekSocInterface, NegativeCaseEmptyMute) {
 ...
 */
TEST(RealtekSocInterface, EdgeCaseSpecialCharsVolume) {
 ...
 */
TEST(RealtekSocInterface, EdgeCaseSpecialCharsMute) {
 ...
 */
TEST(RealtekSocInterface, Valid_source_element_with_proper_GstElement_pointer) {
 ...
 */
TEST(RealtekSocInterface, Null_source_element_pointer) {
 ...
 */
TEST(RealtekSocInterface, ValidGstObjectPointer_SetsDecodeErrorFlag) {
 ...
 */
TEST(RealtekSocInterface, NullGstObjectPointer_HandledSafely) {
 ...
 */
TEST(RealtekSocInterface, SetFreerunThreshold_ValidGstObject) {
 ...
 */
TEST(RealtekSocInterface, SetFreerunThreshold_NullGstObject) {
 ...
 */
TEST(RealtekSocInterface, ValidGstCapsPointerProvided) {
 ...
 */
TEST(RealtekSocInterface, NullGstCapsPointerProvided) {
 ...
 */
TEST(RealtekSocInterface, ValidGstCaps) {
 ...
 */
TEST(RealtekSocInterface, NullGstCaps) {
 ...
 */
TEST(RealtekSocInterface, SetPlatformPlaybackRate_start) {
 ...
 */
TEST(RealtekSocInterface, SetPlaybackFlags_nonSubtitle_zeroInitialFlag) {
 ...
 */
TEST(RealtekSocInterface, SetPlaybackFlags_subtitle_zeroInitialFlag) {
 ...
 */
TEST(RealtekSocInterface, SetPlaybackFlags_nonSubtitle_negativeFlag) {
 ...
 */
TEST(RealtekSocInterface, SetPlaybackFlags_subtitle_negativeFlag) {
 ...
 */
TEST(RealtekSocInterface, SetPlaybackFlags_subtitle_maxInt) {
 ...
 */
TEST(RealtekSocInterface, SetPlaybackFlags_nonSubtitle_maxInt) {
 ...
 */
TEST(RealtekSocInterface, ValidParametersNormalPlaybackRate)
{
 ...
 */
TEST(RealtekSocInterface, ValidParametersIncreasedPlaybackRate)
{
 ...
 */
TEST(RealtekSocInterface, EmptySourcesVector)
{
 ...
 */
TEST(RealtekSocInterface, NullPipelineElement)
{
 ...
 */
TEST(RealtekSocInterface, NullVideoDecoderElement)
{
...
TEST(RealtekSocInterface, NullAudioDecoderElement)
{
 ...
 */
TEST(RealtekSocInterface, ZeroPlaybackRate)
{
 ...
 */
TEST(RealtekSocInterface, NegativePlaybackRate)
{
 ...
 */
TEST(RealtekSocInterface, SourcesVectorContainingNullptrElement)
{
 ...
 */
TEST(RealtekSocInterface, SetRateCorrection_start) {
 ...
 */
TEST(RealtekSocInterface, ValidSinkAsyncEnabled)
{
 ...
 */
TEST(RealtekSocInterface, ValidSinkAsyncDisabled)
{
 ...
 */
TEST(RealtekSocInterface, NullSinkAsyncEnabled)
{
 ...
 */
TEST(RealtekSocInterface, NullSinkAsyncDisabled)
{
 ...
 */
TEST(RealtekSocInterface, ValidGstElementPositiveBuffer) {
 ...
 */
TEST(RealtekSocInterface, ValidGstElementZeroBuffer) {
 ...
 */
TEST(RealtekSocInterface, ValidGstElementNegativeBuffer) {
 ...
 */
TEST(RealtekSocInterface, NullGstElementPositiveBuffer) {
