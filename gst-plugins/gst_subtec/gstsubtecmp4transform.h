 ...
 *
 * Macro to get the GType for GstSubtecMp4Transform.
 */
#define GST_TYPE_SUBTECMP4TRANSFORM   (gst_subtecmp4transform_get_type())

/**
 * GST_SUBTECMP4TRANSFORM:
 * @obj: Object to cast.
 *
 * Macro to cast an object to GstSubtecMp4Transform.
 */
#define GST_SUBTECMP4TRANSFORM(obj)   (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_SUBTECMP4TRANSFORM,GstSubtecMp4Transform))

/**
 * GST_SUBTECMP4TRANSFORM_CLASS:
 * @klass: Class to cast.
 *
 * Macro to cast a class to GstSubtecMp4TransformClass.
 */
...
/**
 * GST_IS_SUBTECMP4TRANSFORM:
 * @obj: Object to check.
 *
 * Macro to check if an object is of type GstSubtecMp4Transform.
 */
#define GST_IS_SUBTECMP4TRANSFORM(obj)   (G_TYPE_CHECK_INSTANCE_TYPE((obj),GST_TYPE_SUBTECMP4TRANSFORM))

/**
 * GST_IS_SUBTECMP4TRANSFORM_CLASS:
 * @klass: Class to check.
 *
 * Macro to check if a class is of type GstSubtecMp4TransformClass.
 */
 ...
 * @base_subtecmp4transform: Parent GstBaseTransform structure.
 *
 * Structure representing the GstSubtecMp4Transform element.
 */
...
/**
 * GstSubtecMp4TransformClass:
 * @base_subtecmp4transform_class: Parent GstBaseTransformClass structure.
 *
 * Class structure for GstSubtecMp4Transform.
 */
...
/**
 * gst_subtecmp4transform_get_type:
 *
 * Returns the GType for GstSubtecMp4Transform.
 *
 * Returns: The GType of GstSubtecMp4Transform.
 */
