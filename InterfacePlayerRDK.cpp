...
#ifdef MWPLAYER_TELEMETRY_SUPPORT /** verifying telemetry support*/
    MW_LOG_MIL("MWPLAYER_TELEMETRY_SUPPORT is enabled at runtime");
#else
    MW_LOG_MIL("MWPLAYER_TELEMETRY_SUPPORT is NOT enabled at runtime");
#endif
