 ...
 */
TEST(PlayerHlsDrmSessionInterfaceBase, RegisterValidGetHlsDrmSessionCbTest) {
 ...
 */
TEST(PlayerHlsDrmSessionInterfaceBase, RegisterEmptyGetHlsDrmSessionCbTest) {
 ...
 */
TEST(PlayerHlsDrmSessionInterfaceBase, createSessionValid)
{
 ...
 */
TEST(PlayerHlsDrmSessionInterfaceBase, NegativeStreamType)
{
 ...
 */
TEST(PlayerHlsDrmSessionInterfaceBase, DefaultDrmInfo) {
