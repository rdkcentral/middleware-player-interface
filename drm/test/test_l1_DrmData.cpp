 ...
 */
TEST(DrmData, CopyConstructorIsDeletedTest)
{
 ...
 */
TEST(DrmData, PositiveValidString)
{
 ...
 */
TEST(DrmData, PositiveEmptyString)
{
 ...
 */
TEST(DrmData, NegativeNullPointer)
{
 ...
 */
TEST(DrmData, AppendValidNonEmptyData)
{
 ...
 */
TEST(DrmData, AppendValidPointerWithZeroLength)
{
 ...
 */
TEST(DrmData, AppendNullPointerWithZeroLength)
{
 ...
 */
TEST(DrmData, DefaultConstructorReturnsEmptyString)
{
 ...
 */
TEST(DrmData, DefaultConstructed_getDataLength)
{
 ...
 */
TEST(DrmData, OperatorAssignmentDeletionCheck)
{
 ...
 */
TEST(DrmData, PositiveValidNonEmptyStringData) 
{ 
 ...
 */
TEST(DrmData, PositiveValidPointerZeroLength) 
{ 
 ...
 */
TEST(DrmData, PositiveEmptyStringData) 
{ 
 ...
 */
TEST(DrmData, NegativeNullPointerNonZeroLength) 
{ 
 ...
 */
TEST(DrmData, Destruction_DefaultConstructor)
{
