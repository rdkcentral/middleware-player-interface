 ...
 */
TEST(FakeHlsDrmSessionManager, PositiveStreamType) {
 ...
 */
TEST(FakeHlsDrmSessionManager, NegativeStreamType) {
 ...
 */
TEST(FakeHlsDrmSessionManager, DefaultConstructedDrmInfo) {
 ...
 */
TEST(FakeHlsDrmSessionManager, RegisterValidCallbackAndVerifyStorage) {
 ...
 */
TEST(FakeHlsDrmSessionManager, RegisterEmptyCallbackAndVerifyStorage) {
 ...
 */
TEST(PlayerHlsDrmSessionInterface, RegisterValidCallback) {
 ...
 */
TEST(PlayerHlsDrmSessionInterface, RegisterEmptyCallback) {
 ...
 */
TEST(PlayerHlsDrmSessionInterface, ValidDRMSession_PositiveType)
{
 ...
 */
TEST(PlayerHlsDrmSessionInterface, ValidInstanceCreation) {
