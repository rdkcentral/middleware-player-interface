 ...
 */
TEST(DrmMemoryHandleCloser, InitializeWithPositiveHandleValue)
{
 ...
 */
TEST(DrmMemoryHandleCloser, InitializeWithNegativeHandleValue)
{
 ...
 */
TEST(DrmMemoryHandleCloser, InitializeWithMaxIntHandleValue)
{
 ...
 */
TEST(DrmMemoryHandleCloser, InitializeWithMinIntHandleValue)
{
