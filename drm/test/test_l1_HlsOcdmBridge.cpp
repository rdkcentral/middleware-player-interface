 ...
 */
TEST(HlsOcdmBridge, AcquireKeyWithValidMetadataAndValidTrackType) {
 ...
 */
TEST(HlsOcdmBridge, AcquireKeyWithNullMetadataAndValidTrackType) {
 ...
 */
TEST(HlsOcdmBridge, AcquireKeyWithValidMetadataAndNegativeTrackType) {
 ...
 */
TEST(HlsOcdmBridge, AcquireKeyWithValidMetadataAndExtremePositiveTrackType) {
 ...
 */
TEST(HlsOcdmBridge, AcquireKeyWithValidMetadataAndExtremeNegativeTrackType) {
 ...
 */
TEST(HlsOcdmBridge, CancelKeyWaitNormally) {
 ...
 */
TEST(HlsOcdmBridge, ValidDecryptionDefaultTime) {
 ...
 */
TEST(HlsOcdmBridge, DecryptionFailureNullData) {
 ...
 */
TEST(HlsOcdmBridge, DecryptionFailureZeroDataLength) {
 ...
 */
TEST(HlsOcdmBridge, DecryptionFailureNegativeTime) {
 ...
 */
TEST(HlsOcdmBridge, DecryptionFailureInvalidBucket) {
 ...
 */
TEST(HlsOcdmBridge, VerifyGetStateReturnsValidState) {
 ...
 */
TEST(HlsOcdmBridge, Constructing_HlsOcdmBridge_With_Valid_DrmSession)
{
 ...
 */
TEST(HlsOcdmBridge, Constructing_HlsOcdmBridge_With_Null_DrmSession)
{
 ...
 */
TEST(HlsOcdmBridge, Release_CleansUpActiveDRMSessionResources) {
 ...
 */
TEST(HlsOcdmBridge, RestoreKeyState_NoThrow) {
 ...
 */
TEST(HlsOcdmBridge, ValidDrmInfo_PositiveWait) {
 ...
 */
TEST(HlsOcdmBridge, ValidDrmInfo_ZeroWait) {
 ...
 */
TEST(HlsOcdmBridge, ValidDrmInfo_MaxWait) {
 ...
 */
TEST(HlsOcdmBridge, NullDrmInfo_PositiveWait) {
 ...
 */
TEST(HlsOcdmBridge, ValidDrmInfo_NegativeWait) {
 ...
 */
TEST(HlsOcdmBridge, PositiveTest_SetMetaData) {
 ...
 */
TEST(HlsOcdmBridge, NegativeTest_SetMetaData) {
 ...
 */
TEST(HlsOcdmBridge, DestructorProperCleanup) {
