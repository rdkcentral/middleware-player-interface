 ...
 */
TEST(DrmJsonObject, DrmJsonObject_DefaultConstructor) {
 ...
 */
TEST(DrmJsonObject, MoveConstructorValidNonEmpty) {
 ...
 */
TEST(DrmJsonObject, MoveConstructorEmpty) {
 ...
 */
TEST(DrmJsonObject, Construct_ValidSimpleJson) {
 ...
 */
TEST(DrmJsonObject, Construct_ValidNestedJson) {
 ...
 */
TEST(DrmJsonObject, Construct_EmptyJson) {
 ...
 */
TEST(DrmJsonObject, Construct_NullPointerJson) {
 ...
 */
TEST(DrmJsonObject, ValidMinimalJsonString) {
    ...
    std::cout << "After construction, expecting internal state: mJsonObj is not NULL for empty JSON object." << std::endl;
 ...
 */
TEST(DrmJsonObject, ValidComplexJsonString) {
 ...
 */
TEST(DrmJsonObject, ValidNestedAdditionEmpty) {
 ...
 */
TEST(DrmJsonObject, ValidNestedAdditionNonEmpty) {
 ...
 */
TEST(DrmJsonObject, AddWithEmptyName) {
 ...
 */
TEST(DrmJsonObject, SelfReferencingAddition) {
 ...
 */
TEST(DrmJsonObject, AddingValidNonEmptyKeyWithTrue) {
 ...
 */
TEST(DrmJsonObject, AddingValidNonEmptyKeyWithFalse) {
 ...
 */
TEST(DrmJsonObject, AddingEmptyKeyWithTrue) {
 ...
 */
TEST(DrmJsonObject, AddingKeyWithSpecialCharacters) {
 ...
 */
TEST(DrmJsonObject, AddValidNumber) {
 ...
 */
TEST(DrmJsonObject, AddValidString) {
 ...
 */
TEST(DrmJsonObject, AddEmptyName) {
...
TEST(DrmJsonObject, AddNullValue) {
    ...
    bool result = obj.add(name, nullptr);
    std::cout << "DrmJsonObject::add returned: " << std::boolalpha << result << std::endl;
 ...
 */
TEST(DrmJsonObject, AddSpecialCharacters) {
 ...
 */
TEST(DrmJsonObject, AddingValidArray) {
 ...
 */
TEST(DrmJsonObject, AddingEmptyVector) {
 ...
 */
TEST(DrmJsonObject, AddingEmptyName) {
 ...
 */
TEST(DrmJsonObject, AddingMixedValues) {
 ...
 */
TEST(DrmJsonObject, AddingLargeVector) {
 ...
 */
TEST(DrmJsonObject, AddValidKeyPositiveDoubleValue) {
 ...
 */
TEST(DrmJsonObject, AddValidKeyNegativeDoubleValue) {
 ...
 */
TEST(DrmJsonObject, AddValidKeyZeroValue) {
 ...
 */
TEST(DrmJsonObject, AddValidKeyMaxDoubleValue) {
 ...
 */
TEST(DrmJsonObject, AddEmptyStringKey) {
 ...
 */
TEST(DrmJsonObject, ValidAddPositiveInt) {
 ...
 */
TEST(DrmJsonObject, ValidAddNegativeInt) {
 ...
 */
TEST(DrmJsonObject, ValidAddZeroValue) {
 ...
 */
TEST(DrmJsonObject, InvalidAddEmptyName) {
 ...
 */
TEST(DrmJsonObject, ValidAddIntMax) {
 ...
 */
TEST(DrmJsonObject, ValidAddIntMin) {
 ...
 */
TEST(DrmJsonObject, ValidAddSpecialCharacters) {
 ...
 */
TEST(DrmJsonObject, AddValidPositiveLongValue) {
 ...
 */
TEST(DrmJsonObject, AddValidNegativeLongValue) {
 ...
 */
TEST(DrmJsonObject, AddValidZeroLongValue) {
 ...
 */
TEST(DrmJsonObject, AddEntryWithMaxLongValue) {
 ...
 */
TEST(DrmJsonObject, AddEntryWithMinLongValue) {
 ...
 */
TEST(DrmJsonObject, AddEntryWithEmptyName) {
 ...
 */
TEST(DrmJsonObject, ValidInputWithNonEmptyVector) {
 ...
 */
TEST(DrmJsonObject, ValidInputWithEmptyVector) {
 ...
 */
TEST(DrmJsonObject, InvalidInputEmptyName) {
 ...
 */
TEST(DrmJsonObject, InvalidInputWithNullptrElements) {
 ...
 */
TEST(DrmJsonObject, RetrieveExistingNestedJSONObject) {
 ...
 */
TEST(DrmJsonObject, RetrieveNonObjectProperty) {
 ...
 */
TEST(DrmJsonObject, RetrieveWithEmptyKey) {
 ...
 */
TEST(DrmJsonObject, RetrievalOfNonexistentProperty) {
 ...
 */
TEST(DrmJsonObject, ValidIntegerPropertyExists) {
 ...
 */
TEST(DrmJsonObject, PropertyDoesNotExist) {
 ...
 */
TEST(DrmJsonObject, PropertyIsNotInteger) {
 ...
 */
TEST(DrmJsonObject, EmptyPropertyNameProvided) {
 ...
 */
TEST(DrmJsonObject, RetrieveExistingPropertyTest) {
 ...
 */
TEST(DrmJsonObject, RetrieveNonExistingPropertyTest) {
 ...
 */
TEST(DrmJsonObject, RetrieveEmptyNamePropertyTest) {
 ...
 */
TEST(DrmJsonObject, RetrieveValidArrayOfJSONObjects) {
 ...
 */
TEST(DrmJsonObject, RetrievePropertyNotArray) {
 ...
 */
TEST(DrmJsonObject, RetrieveEmptyPropertyName) {
 ...
 */
TEST(DrmJsonObject, GetExistingArrayMultiple) {
 ...
 */
TEST(DrmJsonObject, GetWithEmptyName) {
 ...
 */
TEST(DrmJsonObject, IsArray_ReturnTrue_ForArrayKey) {
 ...
 */
TEST(DrmJsonObject, IsArray_ReturnFalse_ForNonArrayKey) {
 ...
 */
TEST(DrmJsonObject, IsArray_ReturnFalse_ForEmptyKey) {
 ...
 */
TEST(DrmJsonObject, FieldWithIntegerNumericValue) {
 ...
 */
TEST(DrmJsonObject, NonExistentField) {
 ...
 */
TEST(DrmJsonObject, EmptyFieldName) {
 ...
 */
TEST(DrmJsonObject, FieldNameWithSpecialCharacters) {
 ...
 */
TEST(DrmJsonObject, ValidJsonObjectName_ReturnsTrue) {
 ...
 */
TEST(DrmJsonObject, NonObjectValueKey_ReturnsFalse) {
 ...
 */
TEST(DrmJsonObject, NonExistingKey_ReturnsFalse) {
 ...
 */
TEST(DrmJsonObject, EmptyStringKey_ReturnsFalse) {
 ...
 */
TEST(DrmJsonObject, SpecialCharactersKey_ReturnsFalse) {
 ...
 */
TEST(DrmJsonObject, VerifyIsStringReturnsTrueWhenAttributeIsAString) {
 ...
 */
TEST(DrmJsonObject, VerifyIsStringReturnsFalseWhenAttributeIsNotAString) {
 ...
 */
TEST(DrmJsonObject, VerifyIsStringReturnsFalseWhenAttributeDoesNotExist) {
 ...
 */
TEST(DrmJsonObject, VerifyIsStringReturnsFalseWhenEmptyAttributeNameIsProvided) {
 ...
 */
TEST(DrmJsonObject, ValidJSONPrintOnEmptyOutputVector)
{
 ...
 */
TEST(DrmJsonObject, print_UnFormatted) {
 ...
 */
TEST(DrmJsonObject, Destructor_With_Valid_Allocated_Resources)
{
 ...
 */
TEST(DrmJsonObject, ValidInputWithTypicalNameAndValue) {
 ...
 */
TEST(DrmJsonObject, ValidInputWithEmptyValue) {
 ...
 */
TEST(DrmJsonObject, InvalidInputWithNullValue) {
 ...
 */
TEST(DrmJsonObject, ValidAdditionAllEncoding) {
 ...
 */
TEST(DrmJsonObject, ValidAdditionEmptyValue) {
 ...
 */
TEST(DrmJsonObject, ValidAdditionLargeInput) {
 ...
 */
TEST(DrmJsonObject, NegativeAdditionEmptyName) {
 ...
 */
TEST(DrmJsonObject, AddWithValidNameNonEmptyByteVector)
{
 ...
 */
TEST(DrmJsonObject, AddWithEmptyNameNonEmptyByteVector)
{
 ...
 */
TEST(DrmJsonObject, AddWithValidNameEmptyByteVector)
{
 ...
 */
TEST(DrmJsonObject, ValidRetrieval_StringEncoding) {
 ...
 */
TEST(DrmJsonObject, ValidRetrieval_Base64) {
 ...
 */
TEST(DrmJsonObject, ValidRetrieval_Base64Url) {
 ...
 */
TEST(DrmJsonObject, MissingProperty) {
 ...
 */
TEST(DrmJsonObject, EmptyPropertyName_StringEncoding) {
 ...
 */
TEST(DrmJsonObject, EmptyPropertyName_Base64) {
 ...
 */
TEST(DrmJsonObject, EmptyPropertyName_Base64Url) {
