 ...
 */
TEST(AesDec, AcquireKey_no_params)
{
 ...
 */
TEST(AesDec, AcquireKey_NullptrMetadata_ValidTrackType)
{
 ...
 */
TEST(AesDec, AcquireKey_ValidMetadata_NegativeTrackType)
{
 ...
 */
TEST(AesDec, AcquireKey_NullptrMetadata_NegativeTrackType)
{
 ...
 */
TEST(AesDec, AcquireKey_ValidMetadata_LargeTrackType)
{
 ...
 */
TEST(AesDec, AcquireKey_ValidMetadata_ZeroTrackType)
{
 ...
 */
TEST(AesDec, AesDecConstructor_start)
{
 ...
 */
TEST(AesDec, CancelKeyWait_activeKeyWaitOperation)
{
 ...
 */
TEST(AesDec, ValidDecryptionTest)
{
 ...
 */
TEST(AesDec, NegativeBucketTypeTest)
{
 ...
 */
TEST(AesDec, NotifyDRMError_validDrmErrors)
{
    ...
    for (DrmTuneFailure error : drmErrors)
    {
        ...
        EXPECT_NO_THROW(aesDec.NotifyDRMError(error));
 ...
 */
TEST(AesDec, ValidInstanceRelease)
{
 ...
 */
TEST(AesDec, RestoreKeyState_correctly_restores_DRM_key_state)
{
 ...
 */
TEST(AesDec, ValidDrmInfo_PositiveKeyWaitTime_Success)
{
 ...
 */
TEST(AesDec, NullDrmInfo_ReturnsDrmError)
{
 ...
 */
TEST(AesDec, ValidDrmInfo_ZeroAcquireKeyWaitTime_ReturnsTimeout)
{
 ...
 */
TEST(AesDec, ValidNonNullMetadataWithTypicalTrack)
{
 ...
 */
TEST(AesDec, NullMetadataWithValidTrack)
{
 ...
 */
TEST(AesDec, ValidNonNullMetadataWithNegativeTrack)
{
 ...
 */
TEST(AesDec, ValidNonNullMetadataWithMaxIntTrack)
{
 ...
 */
TEST(AesDec, InvokeSignalDrmError)
{
 ...
 */
TEST(AesDec, SignalKeyAcquired_successfully_notifies_waiting_threads)
{
 ...
 */
TEST(AesDec, WaitForKeyAcquireCompleteUnlocked_SuccessfulKeyAcquisition)
{
 ...
 */
TEST(AesDec, WaitForKeyAcquireCompleteUnlocked_ZeroWaitTimeImmediateTimeout)
{
 ...
 */
TEST(AesDec, Successful_key_acquisition)
{
 ...
 */
TEST(AesDec, AesDec_Destructor_Default)
{
