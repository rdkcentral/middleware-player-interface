...
function install_pkgs_fn()
{
  if [[ "$OSTYPE" == "darwin"* ]]; then
      ...
      install_pkgs_darwin_fn git json-glib cmake "openssl@3.5" libxml2 ossp-uuid cjson gnu-sed jpeg-turbo taglib speex mpg123 meson ninja pkg-config flac asio jsoncpp lcov gcovr jq curl
