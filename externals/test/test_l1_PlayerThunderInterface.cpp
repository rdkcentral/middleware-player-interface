 ...
 */
TEST(PlayerThunderInterface, ActivatePlugin_AllValidEnums) {
 ...
 */
TEST(PlayerThunderInterface, ActivatePlugin_InvalidEnum) {
 ...
 */
TEST(PlayerThunderInterface, ValidPositiveLayerID) {
 ...
 */
TEST(PlayerThunderInterface, ZeroLayerID) {
 ...
 */
TEST(PlayerThunderInterface, NegativeLayerID) {
 ...
 */
TEST(PlayerThunderInterface, ExtremeMaximumLayerID) {
 ...
 */
TEST(PlayerThunderInterface, ExtremeMinimumLayerID) {
 ...
 */
TEST(PlayerThunderInterface, DeleteWatermark_ValidPositiveLayerID) {
 ...
 */
TEST(PlayerThunderInterface, DeleteWatermark_LayerIDZero) {
 ...
 */
TEST(PlayerThunderInterface, DeleteWatermark_NegativeLayerID) {
 ...
 */
TEST(PlayerThunderInterface, DeleteWatermark_INT_MAX) {
 ...
 */
TEST(PlayerThunderInterface, DeleteWatermark_INT_MIN) {
 ...
 */
TEST(PlayerThunderInterface, ValidTypicalValues) {
 ...
 */
TEST(PlayerThunderInterface, UnlimitedGracePeriod) {
 ...
 */
TEST(PlayerThunderInterface, ZeroValues) {
 ...
 */
TEST(PlayerThunderInterface, InvalidNegativeGrace) {
 ...
 */
TEST(PlayerThunderInterface, InvalidNegativeTime) {
 ...
 */
TEST(PlayerThunderInterface, ExtremelyLargeBoundaryValues) {
 ...
 */
TEST(PlayerThunderInterface, EnableContentRestrictionsOta_WithValidPlayerThunderAccess) {
 ...
 */
TEST(PlayerThunderInterface, SingleValidAudioTrack) {
 ...
 */
TEST(PlayerThunderInterface, MultipleValidAudioTracks) {
 ...
 */
TEST(PlayerThunderInterface, EmptyAudioTracksVector) {
 ...
 */
TEST(PlayerThunderInterface, AudioTrackWithNegativePk) {
 ...
 */
TEST(PlayerThunderInterface, AudioTrackWithEmptyStringFields) {
 ...
 */
TEST(PlayerThunderInterface, GetMetaDataWatermark_SuccessfulRetrieval) {
 ...
 */
TEST(PlayerThunderInterface, GetTextTracksOta_ValidEmptyVector) {
 ...
 */
TEST(PlayerThunderInterface, HideWatermark_start) {
 ...
 */
TEST(PlayerThunderInterface, IsThunderAccess_ThunderAccessAvailable) {
 ...
 */
TEST(PlayerThunderInterface, ExtremePositiveLayerID) {
 ...
 */
TEST(PlayerThunderInterface, ExtremeNegativeLayerID) {
 ...
 */
TEST(PlayerThunderInterface, ValidBase64AndValidMetadata) {
 ...
 */
TEST(PlayerThunderInterface, ValidBase64AndEmptyMetadata) {
 ...
 */
TEST(PlayerThunderInterface, ValidBase64AndWhitespaceMetadata) {
 ...
 */
TEST(PlayerThunderInterface, EmptyBase64AndValidMetadata) {
 ...
 */
TEST(PlayerThunderInterface, NullBase64AndValidMetadata) {
 ...
 */
TEST(PlayerThunderInterface, InvalidBase64AndValidMetadata) {
 ...
 */
TEST(PlayerThunderInterface, ConstructValidPluginCallsign) {
 ...
 */
TEST(PlayerThunderInterface, ConstructInvalidPluginCallsign) {
 ...
 */
TEST(PlayerThunderInterface, RegisterBothCallbacksWithValidLambdas) {
 ...
 */
TEST(PlayerThunderInterface, RegisterValidSignalEmptyInput) {
 ...
 */
TEST(PlayerThunderInterface, RegisterEmptySignalValidInput) {
 ...
 */
TEST(PlayerThunderInterface, RegisterBothEmptyCallbacks) {
 ...
 */
TEST(PlayerThunderInterface, RegisterValidCallback) {
 ...
 */
TEST(PlayerThunderInterface, RegisterEmptyCallback) {
 ...
 */
TEST(PlayerThunderInterface, RegisterValidCallbackFunction) {
 ...
 */
TEST(PlayerThunderInterface, ReleaseOta_start) {
 ...
 */
TEST(PlayerThunderInterface, PositiveValidAudioTrackOta) {
 ...
 */
TEST(PlayerThunderInterface, NegativeAudioIndexValidPrimaryKey) {
 ...
 */
TEST(PlayerThunderInterface, PositiveAudioIndexNegativePrimaryKey) {
 ...
 */
TEST(PlayerThunderInterface, EdgeCaseZeroAudioIndexValidPrimaryKey) {
 ...
 */
TEST(PlayerThunderInterface, BoundaryMaxValuesAudioTrackOta) {
 ...
 */
TEST(PlayerThunderInterface, ValidPreferredAudioData_AllValidShims) {
 ...
 */
TEST(PlayerThunderInterface, EmptyStringsInPreferredAudioData_WithValidShim) {
 ...
 */
TEST(PlayerThunderInterface, ValidRectangleStandardPositiveDimensions) {
 ...
 */
TEST(PlayerThunderInterface, ValidRectangleMinimumNonZeroDimensions) {
 ...
 */
TEST(PlayerThunderInterface, NegativeXCoordinate) {
 ...
 */
TEST(PlayerThunderInterface, NegativeYCoordinate) {
 ...
 */
TEST(PlayerThunderInterface, ZeroWidthValue) {
 ...
 */
TEST(PlayerThunderInterface, ZeroHeightValue) {
 ...
 */
TEST(PlayerThunderInterface, EmptyVideoInputType) {
 ...
 */
TEST(PlayerThunderInterface, ValidRectangleWithInvalidShimValue) {
 ...
 */
TEST(PlayerThunderInterface, ShowWatermark_LowerBoundary0) {
 ...
 */
TEST(PlayerThunderInterface, ShowWatermark_MidRange50) {
 ...
 */
TEST(PlayerThunderInterface, ShowWatermark_UpperBoundary100) {
 ...
 */
TEST(PlayerThunderInterface, ShowWatermark_NegativeOpacityMinus1) {
 ...
 */
TEST(PlayerThunderInterface, ShowWatermark_OpacityAboveMax101) {
 ...
 */
TEST(PlayerThunderInterface, ValidInputCommonPort) {
 ...
 */
TEST(PlayerThunderInterface, ValidInputLowerBoundary) {
 ...
 */
TEST(PlayerThunderInterface, ValidInputUpperBoundary) {
 ...
 */
TEST(PlayerThunderInterface, ValidInputEmptyVideoInputType) {
 ...
 */
TEST(PlayerThunderInterface, NegativeInputNegativePort) {
 ...
 */
TEST(PlayerThunderInterface, NegativeInputInvalidVideoInputType) {
 ...
 */
TEST(PlayerThunderInterface, NegativeInputWhitespaceVideoInputType) {
 ...
 */
TEST(PlayerThunderInterface, StartOTAWithAllValidParameters) {
 ...
 */
TEST(PlayerThunderInterface, StartOTAWithEmptyURL) {
 ...
 */
TEST(PlayerThunderInterface, StartOTAWithInvalidURLFormat) {
 ...
 */
TEST(PlayerThunderInterface, StartOTAWithEmptyWaylandDisplay) {
 ...
 */
TEST(PlayerThunderInterface, StartOTAWithEmptyPreferredLanguagesString) {
 ...
 */
TEST(PlayerThunderInterface, StartOTAWithEmptyAtscPreferredLanguagesString) {
 ...
 */
TEST(PlayerThunderInterface, StartOTAWithEmptyPreferredRenditionString) {
 ...
 */
TEST(PlayerThunderInterface, StartOTAWithEmptyAtscPreferredRenditionString) {
 ...
 */
TEST(PlayerThunderInterface, StartOTAWithMultipleLanguageAndRenditionPreferences) {
 ...
 */
TEST(PlayerThunderInterface, ValidURLAndValidCallbacks) {
 ...
 */
TEST(PlayerThunderInterface, EmptyURLWithValidCallbacks) {
 ...
 */
TEST(PlayerThunderInterface, ValidURLWithEmptyStatusHandler) {
 ...
 */
TEST(PlayerThunderInterface, ValidURLWithEmptyErrorHandler) {
 ...
 */
TEST(PlayerThunderInterface, MalformedURLWithValidCallbacks) {
 ...
 */
TEST(PlayerThunderInterface, WhitespaceURLWithValidCallbacks) {
 ...
 */
TEST(PlayerThunderInterface, StopHelperVideoin_WebVTT) {
 ...
 */
TEST(PlayerThunderInterface, StopHelperVideoin_MP4) {
 ...
 */
TEST(PlayerThunderInterface, StopHelperVideoin_EmptyString) {
 ...
 */
TEST(PlayerThunderInterface, StopHelperVideoin_InvalidType) {
 ...
 */
TEST(PlayerThunderInterface, StopOta_ValidInvocation) {
 ...
 */
TEST(PlayerThunderInterface, StopRmf_is_called) {
 ...
 */
TEST(PlayerThunderInterface, UnRegisterAllEventsVideoin_start) {
 ...
 */
TEST(PlayerThunderInterface, UnSubscribeEvent_ValidEvent) {
 ...
 */
TEST(PlayerThunderInterface, UnSubscribeEvent_EmptyEvent) {
 ...
 */
TEST(PlayerThunderInterface, UnSubscribeEvent_NonExistentEvent) {
 ...
 */
TEST(PlayerThunderInterface, UnSubscribeEvent_SpecialCharacters) {
 ...
 */
TEST(PlayerThunderInterface, ValidParametersShouldReturnTrue) {
 ...
 */
TEST(PlayerThunderInterface, NegativeLayerIDShouldReturnFalse) {
 ...
 */
TEST(PlayerThunderInterface, NegativeSharedMemoryKeyShouldReturnFalse) {
 ...
 */
TEST(PlayerThunderInterface, ZeroSizeShouldReturnFalse) {
 ...
 */
TEST(PlayerThunderInterface, NegativeSizeShouldReturnFalse) {
 ...
 */
TEST(PlayerThunderInterface, MaxIntegerValuesShouldReturnTrue) {
 ...
 */
TEST(PlayerThunderInterface, DestructorTest) {
